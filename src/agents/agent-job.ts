...
export function createAgentJob(cwd: string, name: string, task: string, model?: AgentModelSelection): AgentJob {
	...
	return {
		...
		model,
		status: "draft",
		allowedTools: ["read", "grep", "find", "ls", "agent_bash", "agent_write_proposal", "agent_edit_proposal", "agent_view_artifacts", "agent_create_note", "agent_edit_note", "agent_view_notes"],
